$(function(){
  ...
  //     // border with shadow
  //     $('.code.html .triangle span').text('')
  //     $('.code.html .border span').text(' shadow')
  //   } else if( $('input.border_check').attr('checked') ) {
  //     // just border
  //     $('.code.html .triangle span, .code.html .border span').text('')
  //   } else if( $('input.shadow_check').attr('checked') ) {
  //     // triangle with shadow
  //     $('.code.html .triangle span').text(' shadow')
  //     $('.code.html .border span').text('')
  //   } else {
  //     // just triangle
  //     $('.code.html .triangle span, .code.html .border span').text('')
  //   }
  ...
  // $('a.copy').zclip({
  //   path:'scripts/libraries/ZeroClipboard.swf',
  //   copy: function() {
  //     return $(this).next().children().filter(':visible').text()
  //   }
  // });
  
  // $('.copy').click(function(){
  //     console.log( $(this).next().children().filter(':visible').text() )
  //   });
